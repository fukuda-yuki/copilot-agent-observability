...
現在の既定構成は、Sprint1 で確認した Langfuse self-host への直接 OTLP 送信です。
...
次の検討候補である Sprint2 では、Langfuse に依存しない raw telemetry store と normalized dataset を source of truth とし、Langfuse UI を dashboard / trace viewer として再位置づける方針を検討します。Sprint2 の現時点のメモは [docs/sprints/sprint2-raw-data-loop/](docs/sprints/sprint2-raw-data-loop/) にあります。
...
- [docs/sprints/sprint2-raw-data-loop/](docs/sprints/sprint2-raw-data-loop/): Sprint2 の raw data loop 検討メモ
