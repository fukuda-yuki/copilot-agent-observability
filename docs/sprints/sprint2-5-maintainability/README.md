...
| [M4: Redacted real-trace E2E](milestones/M4-redacted-real-trace-e2e/task.md) | 完了 | redacted real Copilot trace 由来 input で raw data loop の最小 E2E evidence を作成した |
