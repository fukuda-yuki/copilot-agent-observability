...
Sprint3 の実装前に、diagnosis candidate を生成する deterministic rule、content-aware pattern、readiness decision rule、sensitive bundle read contract を確定する。
