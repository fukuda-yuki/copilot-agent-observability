...
- 2026-05-26: M17 protocol と M18 dry run の結果に従い、`docs/milestones/M19-baseline-measurement/plan.md` に本計測の実行マトリクス、artifact 置き場、retry 方針、sanitization 方針、review 観点を固定した。
