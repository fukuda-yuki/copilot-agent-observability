...
- `docs/spec.md`
- `docs/task.md`
- `docs/milestones/M22-report-template/report-template.md`
- `docs/milestones/M22-report-template/task.md`
- `docs/milestones/M22-report-template/plan.md`
- `docs/milestones/M22-report-template/notes.md`
...
- `rg -n "total_tokens|turn_count|tool_call_count|duration_ms|success_status|pass|fail|needs-review|not-evaluated" docs/milestones/M22-report-template/report-template.md docs/spec.md`
- `rg -n "baseline_total_tokens_median|variant_total_tokens_median|quality_non_regression_status|comparison_notes" docs/milestones/M22-report-template/report-template.md docs/spec.md`
- `rg -n "prompt / response content|tool arguments / results|credential|secret|Base64 header|user identity" docs/milestones/M22-report-template/report-template.md docs/spec.md`
