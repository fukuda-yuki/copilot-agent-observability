...
- `docs/spec.md`
- `docs/milestones/M21-variant-protocol/task.md`
- `docs/milestones/M21-variant-protocol/plan.md`
- `docs/milestones/M21-variant-protocol/notes.md`
- `docs/task.md`
...
- `rg -n "experiment\\.id|experiment\\.condition|prompt\\.version|agent\\.variant|quality_non_regression_status|自動勝敗|自動採用|自動実装" docs/spec.md docs/milestones/M21-variant-protocol docs/task.md`
- `rg -n "run_status|failure_type|retry_of_run_id|success_status|not-evaluated|pass|fail|needs-review" docs/spec.md docs/milestones/M21-variant-protocol`
