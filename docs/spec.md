...
Sprint3 では、Sprint2.5 の結果を踏まえ、trace からの deterministic な自動診断候補生成、content-aware evidence extraction、改善候補生成、自動採用判断を含む auto-decision record 生成の基盤を扱う。
実 repository 修正を伴う自動改善実装、patch / diff 生成は Sprint3 の既定スコープには含めず、Sprint4 以降の候補として安全境界を定義してから扱う。
...
実 repository 修正を伴う自動改善実装への接続は Sprint4 以降の候補として扱う。
...
Sprint3 の auto-decision record 生成と Sprint4 以降の実 repository 修正を伴う自動改善実装の検討は、M11-M22 の研究計測フェーズとは別スコープで扱う。
...
実 repository 修正を伴う自動改善実装、patch / diff 生成は Sprint4 以降の候補として扱う。
