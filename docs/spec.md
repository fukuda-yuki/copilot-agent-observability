...
| View | 目的 |
| --- | --- |
| Run Overview | trace 数、成功 / 失敗、duration、token、estimated cost、LLM call、tool call を俯瞰する |
| Agent / Tool Behavior | tool / MCP / CLI 操作の call count、error、timeout、duration、repeated call、approval result を確認する |
