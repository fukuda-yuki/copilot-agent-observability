...
- Sprint4 M3 では synthetic fixture から M2 dashboard dataset を生成し、TTFT fallback、estimated cost、operation timing、retry、approval wait、subagent wait、stuck / long-running flags、backlog age、PII 非混入を確認する。
