...
- Sprint4 M1 は `dashboard requirements` とし、dashboard の目的、非目的、view set、metric inventory、dimension / filter、drilldown、data source 境界を確定する。
- Sprint4 の後続候補は M2 dashboard dataset contract、M3 synthetic dashboard data、M4 dashboard prototype path、M5 review and handoff とする。
