...
| Sprint5: Static HTML Observability Dashboard | 計画中 | [docs/sprints/sprint5-static-dashboard/](sprints/sprint5-static-dashboard/) で GitHub Pages 向け static HTML dashboard を Grafana 代替の常設 dashboard 第一候補として扱う |
