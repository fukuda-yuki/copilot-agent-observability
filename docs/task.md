...
| Sprint3: Content-aware Trace Diagnosis and Auto-decision Foundation | 実装中 | [docs/sprints/sprint3-trace-diagnosis/](sprints/sprint3-trace-diagnosis/) で trace content を含む deterministic 診断候補生成、改善候補生成、自動採用判断を含む auto-decision record の基盤を実装する |
...
- Sprint3 は実装段階であり、Sprint2 MVP と Sprint2.5 で除外した trace からの自動診断候補生成を、deterministic rule、content-aware evidence、改善候補生成、自動採用判断を含む auto-decision record まで拡張して扱う。
