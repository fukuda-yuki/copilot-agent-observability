...
| Sprint2: Raw Data Loop | 実装計画済み | [docs/sprints/sprint2-raw-data-loop/](sprints/sprint2-raw-data-loop/) で raw OTLP file ingest、SQLite raw store、normalized dataset、Langfuse 非依存改善ループの後続 milestones を定義した |
...
- Sprint2 の実装は M2 raw store 基盤から開始する。
